...
# IO500 Reproducibility - SC25 - LRZ - SuperMUC-NG-Phase2-EC
...
SuperMUC-NG Phase2 is the expansion of this supercomputer.
...
For SuperMUC-NG Phase2, DAOS support is provided by Lenovo and HPE.
...
[https://github.com/daos-stack/daos-reproducibility/tree/master/io500/sc25/lrz/sng2](https://github.com/daos-stack/daos-reproducibility/tree/master/io500/sc25/lrz/sng2)
...
```
    [ior-easy]
    API = DFS --dfs.pool=di29puz3_pool01 --dfs.cont=cont_rf0_e256kiB --dfs.dir_oclass=RP_2G1 --dfs.oclass=EC_16P1GX --dfs.chunk_size=4MiB
    [ior-hard]
    API = DFS --dfs.pool=di29puz3_pool01 --dfs.cont=cont_rf0_e256kiB --dfs.dir_oclass=RP_2G1 --dfs.oclass=EC_16P1GX --dfs.chunk_size=4MiB
    [mdtest-easy]
    API = DFS --dfs.pool=di29puz3_pool01 --dfs.cont=cont_rf0_e256kiB --dfs.dir_oclass=RP_2GX --dfs.oclass=RP_2G1
    [mdtest-hard]
    API = DFS --dfs.pool=di29puz3_pool01 --dfs.cont=cont_rf0_e256kiB --dfs.dir_oclass=RP_2GX --dfs.oclass=RP_2G1
```
